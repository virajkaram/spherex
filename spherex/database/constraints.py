...
class DBQueryConstraints:
    ...
    def __init__(
        ...
        self.q3c_query = None
        self.postgis_spatial_query = None
    ...
    def add_postgis_within_constraint(self,
                                      ra: float,
                                      dec: float,
                                      footprint_column_name: str = "footprint",
                                      ):
        """
        Add a postgis within constraint
        :param ra:
        :param dec:
        :param footprint_column_name:
        :return:
        """
        constraints = (
            f"ST_Contains({footprint_column_name}, "
            f"ST_SetSRID(ST_MakePoint({ra}, {dec}), 4326))"
        )
        self.postgis_spatial_query = constraints
    ...
    def parse_constraints(
        ...
        if self.postgis_spatial_query is not None:
            constraints.append(self.postgis_spatial_query)
